...
class ImportanceRenderer(torch.nn.Module):
    ...
    def run_model(self, planes, decoder, sample_coordinates, sample_directions, options, triplane_offset=None, aud_feat=None):
        ...
        out = decoder(sampled_features, sample_directions, aud_cond=aud_feat)
